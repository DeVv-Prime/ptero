...
blueprint1() {
  ...
  bash <(curl -s https://raw.githubusercontent.com/DeVv-Prime/The-Coding-Hub/refs/heads/main/srv/thame/blueprint.sh)
  pause
}
...
blueprint2() {
  ...
  bash <(curl -s https://raw.githubusercontent.com/DeVv-Prime/The-Coding-Hub/refs/heads/main/srv/thame/blueprint-2.sh)
  pause
}
...
autofix() {
    ...
    bash <(curl -s https://raw.githubusercontent.com/DeVv-Prime/The-Coding-Hub/refs/heads/main/srv/thame/fix.sh)
    pause
}
...
while true; do
  ...
  case $opt in
    ...
    2) blueprint2 ;;
    3) autofix ;;
    4) bash <(curl -s https://raw.githubusercontent.com/DeVv-Prime/ptero/refs/heads/main/ptero/thame/hyperv1.sh) ;;
    0) 
